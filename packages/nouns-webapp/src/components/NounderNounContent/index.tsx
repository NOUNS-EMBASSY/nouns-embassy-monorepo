      ...
      <Row className={auctionActivityClasses.activityRow}>
        <Col lg={12}>
          <ul className={auctionBidClasses.bidCollection}>
            ...
            >
              <Trans>All Nouns Embassy auction proceeds are sent to the</Trans>{' '}
              ...
              <Trans>
                ...
                Nouns. Every 5th Noun Embassy for the first 5 years of the project will be sent to
                our multisig, where it will be vested and distributed to individual founders.
              </Trans>
            </li>
          </ul>
          <div
