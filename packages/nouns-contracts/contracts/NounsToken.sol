...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    ) ERC721('NOUNS EMBASSY', 'NOUNSEMBASSY') {
     ...
     * Noun. Nounders reward Nouns are minted every 5 Nouns, starting at 0,
     * until 52 nounder Nouns have been minted (5 years w/ 7 days auctions).
     * @dev Call _mintTo with the to address(es).
     */
    function mint() public override onlyMinter returns (uint256) {
        if (_currentNounId <= 260 && _currentNounId % 5 == 0) {
